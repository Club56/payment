...
<head>
    ...
    <!-- Favicons -->
<link href="images/s2.jpg" rel="icon">
<link href="images/s2.jpg" rel="apple-touch-icon">
    <link
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
    ...
    <style>
      ...
      .mpesa {
        background-color: rgb(202, 53, 27) !important;
      }
    ...
    <div class="container d-flex justify-content-center">
      <div class="card mt-5 px-3 py-4">
        <div class="d-flex flex-row justify-content-around">
          <div class="mpesa"><span>Airtel</span></div>
          <div><span><a href="index.php">M-pesa</a></span></div>
          <div><span><a href="https://www.paypal.com/signin">Paypal</a></span></div>         
        </div>
        <div class="media mt-4 pl-2">
          <img src="./images/airtel.png" class="mr-3" height="75" />
